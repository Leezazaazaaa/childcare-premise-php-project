<?php
    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        if (empty($error)) { // if no errors process input
            ...
            // $result = mysqli_query($connection, $query) or die ("not done");
    ...
    ?>
            ...
            <br>
                ...
                <div class="form-group">
                    ...
                    <option>Trained Supervision</option>
                    <option>Social Skill Promotion</option>
                    <option>play time</option>
                    <option>Lunch Service</option>
                    <option>Evening sleeping bed</option> -->
                    </select>
                </div>
