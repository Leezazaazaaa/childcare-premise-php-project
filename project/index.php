    ...
    <p class="card-text"></p>
          ...
          <div class="col-sm-8"> 
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <h5 id="basic-information-title1" class="card-title">New Activities</h5>
                      <p id="basic-information1" class="card-text">
                ...
                <div class="col">
                  <div class="card">
                    <img src="images/gif1.gif" style="height: 360px;" class="card-img-top" alt="gif1">
                    <div class="card-body">
                      <h5 id="basic-information-title1" class="card-title">Special Offers</h5>
                      <p id="basic-information1" class="card-text">
                      ...
                      <a href="#" id="buttons" class="btn btn-lg">Contact For information</a>
                    </div>
                  </div>
                </div>
            ...
            <div id="last-info" class="row row-cols-1 row-cols-md-1 g-4">
                <div class="col">
                  <div class="card">
                    <img src="images/pic6.png" class="card-img-top" alt="pic6">
                    <div class="card-body">
                      <h5 id="basic-information-title1" class="card-title">New Events</h5>
                      <p id="basic-information1" class="card-text">
